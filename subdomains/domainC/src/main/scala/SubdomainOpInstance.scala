...
object SubdomainOpInstanceC extends subdomains.utils.SubdomainOp {
  ...
  override def inputs: Set[Input] = Set(new Input("dataset/spark-op-instance-C", "dataTypePlaceholder", "sourcePlaceholder")) // This should be updated based on actual dependencies
